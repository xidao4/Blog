    ...
    <div class="collection" >
        ...
        <a-list item-layout="horizontal" size="large" v-bind:data-source="collection" style="text-align: left;margin-left: 150px;margin-right: 150px">
            <a-list-item slot="renderItem" slot-scope="item" key="item.id" >
                <row style="text-align: left;margin-left: 200px;margin-right: 200px;">
                    <br>
                    <a slot="title"  @click="jumpToDetails(item.id)" style="text-align: left;font-size: 200%;color:gray" v-if="item.title.length<13">
                        {{item.title}}
                    </a>
                    ...
                    <a-row style="text-align: left;font-size: 120%;overflow:hidden;text-overflow:ellipsis;margin-top: 20px" @click="jumpToDetails(item.id)" >
                        ...
                        <a-col  v-if="item.content.length>100">
                    ...
                    <a-row>
                        ...
                        <a-col style="color: darkgray;text-align: left;margin-left: 500px" :span="12"><a-button  @click="delCollection(item.id) " style="color: #192c3e"><a-icon type="star"></a-icon>取消收藏</a-button></a-col>
                    </a-row>
                    <a-row>
